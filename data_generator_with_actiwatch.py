...
class DataGenerator(tensorflow.keras.utils.Sequence):
    def __init__(self, list_IDs, shuffle=True,lowerbound=0,upperbound=0,date_folder='A',
    build_vars=['A'],
    explode_vars=['A'],
    working_directory='A',
    cur_date='A'):
...
###############################################################################
        ...
        #datax1=datax1.drop(['REAL_DATE_EXT'],axis='columns')

        #datax1=datax1.drop_duplicates()
