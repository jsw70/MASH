...
##load in youden info
youden_with_lux=readRDS(paste(working_dir,"pred_date_",current_date,"/youden_with_lux.RDS",sep=""))

youden_without_lux=readRDS(paste(working_dir,"pred_date_",current_date,"/youden_without_lux.RDS",sep=""))
