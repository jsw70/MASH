...
optimizer='Adam',
              ...
              tf.keras.metrics.Precision(),tf.keras.metrics.BinaryAccuracy(threshold=0.5)]})
...
fpr, tpr, threshold = roc_curve(test_pred.loc[:, 'WI'],test_pred.loc[:, 'PRED_AWAKE'])
roc_auc= auc(fpr, tpr)

###save the predictions
test_pred.to_pickle('predictions_'+model_params['name']+'.pkl')
